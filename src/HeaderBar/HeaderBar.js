...
import VideoArea from '../VideoArea/VideoArea.js'
...
export default function MiniDrawer() {
  ...
  const itemList1 = [
      ...
      { text: "Subscription", icon: <SubscriptionsIcon/> }
  ];
  ...
  const itemList2 = [
      ...
      {text: "Sports", icon: <SportsCricketIcon/>},
      {text: "Music", icon: <MusicNoteIcon/>},
      {text:"News", icon: <ImportContactsIcon/>}
  ];
